import { ar as defineComponent, aH as ref, as as openBlock, at as createElementBlock, aI as normalizeStyle, aF as toDisplayString, aE as createCommentVNode, aB as renderSlot, aA as createBaseVNode, ax as resolveComponent, ay as createBlock, av as withCtx, au as createVNode, aw as createTextVNode } from "./vendor.cdf4b231.js";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { showTitle, isClick, reset };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
const _hoisted_1$2 = ["disabled", "data-title", "aria-label"];
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("button", {
    ...
    "data-title": $props.titleButton,
    "aria-label": $props.ariaLabelButton,
    onFocus: _cache[0] || (_cache[0] = ($event) => $setup.showTitle = true),
    onBlur: _cache[1] || (_cache[1] = ($event) => $setup.reset()),
    onMousedown: _cache[2] || (_cache[2] = ($event) => $setup.isClick = true)
  }, [
    $setup.showTitle && !$setup.isClick ? (openBlock(), createElementBlock("div", {
      key: 0,
      class: "absolute border-2 border-black bg-white p-1 rounded text-black text-base font-normal",
      style: normalizeStyle({
        height: $props.heightTitle + "px",
        width: $props.widthTitle + "px",
        top: $props.positionY + "px",
        left: $props.positionX + "px"
      })
    }, toDisplayString($props.titleButton), 5)) : createCommentVNode("v-if", true),
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_Story, {
    ...
    default: withCtx(() => [
      ...
      createVNode(_component_Variant, { "data-title": "Home Button" }, {
        default: withCtx(() => [
