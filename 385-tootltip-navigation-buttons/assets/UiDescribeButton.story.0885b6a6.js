...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    expose();
    const props = __props;
    const iconMultiplyBlack = new URL("/cooperation_jn_common_ui/385-tootltip-navigation-buttons/assets/icon-multiply-black.9fb2afd7.svg", self.location).href;
    const imgTriangleCornerRight = new URL("/cooperation_jn_common_ui/385-tootltip-navigation-buttons/assets/triangle-corner-right.c277bb19.svg", self.location).href;
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    expose();
    const imgTilt = new URL("/cooperation_jn_common_ui/385-tootltip-navigation-buttons/assets/tilt.71fe043a.svg", self.location).href;
    const imgOrient = new URL("/cooperation_jn_common_ui/385-tootltip-navigation-buttons/assets/orient.833d9b12.svg", self.location).href;
