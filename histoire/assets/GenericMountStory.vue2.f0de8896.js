import { N as defineAsyncComponent, O as Comp1, P as createRouter, Q as createWebHistory, R as createWebHashHistory, S as useDark, U as useToggle, k as watch, V as markRaw, E as reactive, d as defineComponent, r as ref, W as watchEffect, o as openBlock, q as createBlock, X as mergeProps, Y as resolveDynamicComponent, h as createCommentVNode } from "./vendor.9bba3a1c.js";
const scriptRel = "modulepreload";
const assetsURL = function(dep) {
  return "/sigrennesmetropole/cooperation_jn_common_ui/histoire/" + dep;
};
const seen = {};
  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView.vue.b1cabe7d.js"), true ? ["assets/HomeView.vue.b1cabe7d.js","assets/vendor.9bba3a1c.js"] : void 0)
    },
    {
      path: "/story/:storyId",
      name: "story",
      component: () => __vitePreload(() => import("./StoryView.vue.68a8a7ab.js"), true ? ["assets/StoryView.vue.68a8a7ab.js","assets/vendor.9bba3a1c.js","assets/MobileOverlay.vue2.c3a1e95d.js","assets/BaseEmpty.vue.f84feb68.js","assets/state.41f98191.js"] : void 0)
    }
  ]
});
...
const clientSupportPlugins = {
  "vanilla": () => __vitePreload(() => import("./vendor.9bba3a1c.js").then((n) => n.aG), true ? [] : void 0),
  "vue3": () => __vitePreload(() => import("./vendor.9bba3a1c.js").then((n) => n.aH), true ? [] : void 0)
};
const __default__ = {
  inheritAttrs: false
};
