...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    expose();
    const props = __props;
    const iconTooltip = new URL("/cooperation_jn_common_ui/393-footer-component/assets/icon-tooltip.5d977548.svg", self.location).href;
    const iconTooltipRed = new URL("/cooperation_jn_common_ui/393-footer-component/assets/icon-tooltip-red.23db0a98.svg", self.location).href;
