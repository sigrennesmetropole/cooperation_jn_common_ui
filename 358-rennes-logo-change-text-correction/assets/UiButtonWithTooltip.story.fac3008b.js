import { ar as defineComponent, aD as ref, az as computed, as as openBlock, at as createElementBlock, aA as createBaseVNode, aC as normalizeClass, aE as normalizeStyle, aF as toDisplayString, aB as renderSlot, aG as createCommentVNode, aH as Fragment, ax as resolveComponent, ay as createBlock, av as withCtx, au as createVNode } from "./vendor.76bca66d.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    expose();
    const props = __props;
    const iconTooltip = new URL("/cooperation_jn_common_ui/358-rennes-logo-change-text-correction/assets/icon-tooltip.5d977548.svg", self.location).href;
    const iconTooltipRed = new URL("/cooperation_jn_common_ui/358-rennes-logo-change-text-correction/assets/icon-tooltip-red.23db0a98.svg", self.location).href;
    ...
    const __returned__ = { iconTooltip, iconTooltipRed, props, displayTooltip, classDimensionButton, stylePositionButton, stylePositionText };
