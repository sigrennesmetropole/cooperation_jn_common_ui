import { ar as defineComponent, aD as ref, az as computed, as as openBlock, at as createElementBlock, aA as createBaseVNode, aC as normalizeClass, aE as normalizeStyle, aF as toDisplayString, aG as createCommentVNode, aH as Fragment, ax as resolveComponent, ay as createBlock, av as withCtx, au as createVNode } from "./vendor.426e4a43.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    expose();
    const props = __props;
    const iconTooltip = new URL("/cooperation_jn_common_ui/ui-button-with-tooltip/assets/icon-tooltip.c10c8daa.svg", self.location).href;
    const iconTooltipRed = new URL("/cooperation_jn_common_ui/ui-button-with-tooltip/assets/icon-tooltip-red.92c808db.svg", self.location).href;
