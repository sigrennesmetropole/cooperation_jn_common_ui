...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    expose();
    const props = __props;
    const iconMultiplyWhite = new URL("/cooperation_jn_common_ui/591-Tooltips/assets/icon-multiply-white.5169131b.svg", self.location).href;
    ...
    const __returned__ = { props, iconMultiplyWhite, clickClose, close, isDisplayDescribeButton };
...
function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
  return $setup.isDisplayDescribeButton && !$setup.clickClose ? (openBlock(), createElementBlock("div", _hoisted_1$4, [
...
const _hoisted_1$3 = /* @__PURE__ */ createBaseVNode("div", { class: "flex flex-col gap-2.5 text-neutral-200 font-dm-sans font-normal text-sm cursor-default" }, [
  /* @__PURE__ */ createBaseVNode("div", { class: "flex flex-row items-center" }, [
    /* @__PURE__ */ createBaseVNode("p", null, "D\xE9couvrez le mode 3D")
  ])
], -1);
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { iconMultiplyWhite, clickClose, close };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return !$setup.clickClose ? (openBlock(), createElementBlock("div", _hoisted_1$2, [
    renderSlot(_ctx.$slots, "default"),
...
const _hoisted_1 = { class: "flex flex-col gap-2.5 text-neutral-200 font-dm-sans font-normal text-sm cursor-default opacity-80" };
