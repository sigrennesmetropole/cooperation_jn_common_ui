...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    expose();
    const props = __props;
    const iconMultiplyBlack = new URL("/cooperation_jn_common_ui/516-information-tooltip/assets/icon-multiply-black.9fb2afd7.svg", self.location).href;
    const imgTriangleCornerRight = new URL("/cooperation_jn_common_ui/516-information-tooltip/assets/triangle-corner-right.c277bb19.svg", self.location).href;
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    expose();
    const iconMultiplyWhite = new URL("/cooperation_jn_common_ui/516-information-tooltip/assets/icon-multiply-white.5169131b.svg", self.location).href;
    const clickClose = ref(false);
    const close = () => {
      clickClose.value = true;
    };
