...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    expose();
    const props = __props;
    const iconTooltip = new URL("/cooperation_jn_common_ui/516-information-tooltip/assets/icon-tooltip.5d977548.svg", self.location).href;
    const iconTooltipRed = new URL("/cooperation_jn_common_ui/516-information-tooltip/assets/icon-tooltip-red.23db0a98.svg", self.location).href;
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(Fragment, null, [
    ...
    $setup.displayTooltip ? (openBlock(), createElementBlock("div", {
      key: 0,
      class: normalizeClass(["absolute", ($setup.props.widthBoxText, $setup.props.zIndex)]),
