import { ar as defineComponent, aD as ref, az as computed, as as openBlock, at as createElementBlock, aB as renderSlot, aA as createBaseVNode, aG as createCommentVNode, ay as createBlock, av as withCtx, au as createVNode, ax as resolveComponent } from "./vendor.76bca66d.js";
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    expose();
    const props = __props;
    const iconMultiplyBlack = new URL("/cooperation_jn_common_ui/472-compass-information/assets/icon-multiply-black.9fb2afd7.svg", self.location).href;
    const imgTriangleCornerRight = new URL("/cooperation_jn_common_ui/472-compass-information/assets/triangle-corner-right.c277bb19.svg", self.location).href;
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    expose();
    const props = __props;
    const iconMultiplyWhite = new URL("/cooperation_jn_common_ui/472-compass-information/assets/icon-multiply-white.5169131b.svg", self.location).href;
    const clickClose = ref(false);
    const close = () => {
      localStorage.setItem(props.name, "false");
      clickClose.value = true;
