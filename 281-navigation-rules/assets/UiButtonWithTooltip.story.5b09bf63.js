...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    expose();
    const props = __props;
    const iconTooltip = new URL("/cooperation_jn_common_ui/281-navigation-rules/assets/icon-tooltip.c10c8daa.svg", self.location).href;
    const iconTooltipRed = new URL("/cooperation_jn_common_ui/281-navigation-rules/assets/icon-tooltip-red.92c808db.svg", self.location).href;
