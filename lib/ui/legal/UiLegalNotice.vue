...
const expandIcon = new URL(
  '../../../assets/expand-small-bigger-retract-smaller-big.svg',
  import.meta.url
).href
const imgFinancePar = new URL(
  '../../../assets/etiquette-fr.png',
  import.meta.url
).href
defineProps({
  current_url: String,
        ...
        <div>
          ...
          <div class="flex flex-row">
            <p class="underline decoration-1 font-medium">
              <a :href="contact_link" target="_blank"> Nous contacter </a>
            </p>
